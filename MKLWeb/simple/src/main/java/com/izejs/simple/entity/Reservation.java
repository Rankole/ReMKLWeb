...
public class Reservation implements Serializable {
    ...
    public String getReserUserName() {
        return reserUserName;
    }

    public void setReserUserName(String reserUserName) {
        this.reserUserName = reserUserName;
    }
    ...
    public String toString() {
        return "Reservation{" +
            ...
            ", runTimes=" + runTimes +
            ", status=" + status +
            ", reserUserId=" + reserUserId +
            ", reserUserName=" + reserUserName +
        "}";
    }
}
